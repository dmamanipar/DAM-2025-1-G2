...
class MainProductoB extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        BlocProvider(create: (_)=>ProductoBloc(ProductoRepository(),
            CategoriaRepository(), MarcaRepository(),
            UnidadMedidaRepository())..add(ListarProductoEvent()))
                ...
                child: Padding(
                    ...
                    child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ProductoResp personax = producto[index];
                          return Padding(
                                                            ...
                                                            onPressed: () {
                                                              showDialog(
                                                                ...
                                                                if (value
                                                                  ...
                                                                  BlocProvider.of<ProductoBloc>(context).add(DeleteProductoEvent(personax));
                                                                }
                                                              });
                                                            }))
                                                  ],
